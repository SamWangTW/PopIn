            ...
            <View className="gap-4">
                ...
                <Card>
                    <View className="items-center mb-4">
                        ...
                        <Text className="text-xs text-gray-400 -mt-2 mb-2">
                            Tap to change
                        </Text>
                        <Text
                            className="text-2xl font-bold text-osu-dark"
                ...
                {!editing && (
                    <TouchableOpacity
                        ...
                        className="mt-6 items-center justify-center rounded-xl border border-red-300 bg-red-600 py-3"
                        style={{
                            alignSelf: 'stretch',
                            marginBottom: 10,
                        }}
